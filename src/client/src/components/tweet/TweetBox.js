...
class TweetBox extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <nav class="navbar navbar-dark " style={{ height: '60px', backgroundColor: '#03396c', marginTop: '25px', marginLeft: "17px", marginRight: "17px" }}>
                ...
                {this.state.isOpen ? <Fade left><div><div class="card" style={{ marginTop: '15px', marginLeft: "17px", marginRight: "17px", boxShadow: "0 1px 3px 0 #03396c , 0 0 0 2px #03396c" }}>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="Chula" value="Chula" id="Chula" />
                                            <label class="form-check-label" for="defaultCheck1">
                                                จุฬาลงกรณ์มหาวิทยาลัย
                                        </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="Thammasat" value="Thammasat" id="Thammasat" />
                                            <label class="form-check-label" for="defaultCheck1">
                                                มหาวิทยาลัยธรรมศาสตร์
                                        </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="Mahidol" value="Mahidol" id="Mahidol" />
                                            <label class="form-check-label" for="defaultCheck1">
                                                มหาวิทยาลัยมหิดล
                                        </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="Kasetsart" value="Kasetsart" id="Kasetsart" />
                                            <label class="form-check-label" for="defaultCheck1">
                                                มหาวิทยาลัยเกษตรศาสตร์
                                        </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="ChiangMai" value="Chiang Mai" id="Chiang Mai" />
                                            <label class="form-check-label" for="defaultCheck1">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="KhonKaen" value="Khon Kaen" id="Khon Kaen" />
                                            <label class="form-check-label" for="defaultCheck1">
                                                มหาวิทยาลัยขอนแก่น
                                        </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="Srinakharinwirot" value="Srinakharinwirot" id="Srinakharinwirot" />
                                            <label class="form-check-label" for="defaultCheck1">
                                                มหาวิทยาลัยศรีนครินทรวิโรฒ
                                        </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="Mahasarakham" value="Mahasarakham" id="Mahasarakham" />
                                            <label class="form-check-label" for="defaultCheck1">
                                                มหาวิทยาลัยมหาสารคาม
                                        </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="Burapha" value="Burapha" id="Burapha" />
                                            <label class="form-check-label" for="defaultCheck1">
                                                มหาวิทยาลัยบูรพา
                                        </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" ref="MaeFahLuang" value="Mae Fah Luang" id="Mae Fah Luang" />
                                            <label class="form-check-label" for="defaultCheck1">
